...
class GetExchangeRateAdapter {
    ...
    public ResponseEntity<Map<String, String>> getExchangeRate(final Currency source, final Currency target) {
        final double rate = getExchangeRateUseCase.getExchangeRate(source, target);
